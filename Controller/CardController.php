...
use SlotMachine\SlotBundle\Entity\Card;
use SlotMachine\SlotBundle\Form\CardType;
...
class CardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SlotMachineSlotBundle:Card')->findAll();

        return $this->render('SlotMachineSlotBundle:Card:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SlotMachineSlotBundle:Card:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SlotMachineSlotBundle:Card')->find($id);
        ...
        return $this->render('SlotMachineSlotBundle:Card:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SlotMachineSlotBundle:Card:edit.html.twig', array(
            'entity'      => $entity,
